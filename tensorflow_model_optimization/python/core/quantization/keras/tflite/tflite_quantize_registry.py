...
class TFLiteQuantizeRegistry(quantize_registry.QuantizeRegistry, _RNNHelper):
  ...
  _LAYER_QUANTIZE_INFO = [
      ...
      _QuantizeInfo(layers.GRUCell, ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(layers.LSTMCell, ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(tf.keras.experimental.PeepholeLSTMCell,
                    ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(layers.SimpleRNNCell, ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),

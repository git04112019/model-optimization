...
class TFLiteQuantizeRegistry(quantize_registry.QuantizeRegistry, _RNNHelper):
  ...
  _LAYER_QUANTIZE_INFO = [
      ...
      _QuantizeInfo(tf.compat.v1.keras.layers.GRUCell,
                    ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(tf.compat.v2.keras.layers.GRUCell,
                    ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(tf.compat.v1.keras.layers.LSTMCell,
                    ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(tf.compat.v2.keras.layers.LSTMCell,
                    ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(tf.compat.v1.keras.experimental.PeepholeLSTMCell,
                    ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(tf.compat.v2.keras.experimental.PeepholeLSTMCell,
                    ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(tf.compat.v1.keras.layers.SimpleRNNCell,
                    ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
      _QuantizeInfo(tf.compat.v2.keras.layers.SimpleRNNCell,
                    ['kernel', 'recurrent_kernel'],
                    ['activation', 'recurrent_activation']),
